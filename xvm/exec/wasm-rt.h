...
typedef struct {
   ...
   *    => returns 1
   *  ``` */
  uint32_t (*wasm_rt_register_func_type)(void* context,
                                         uint32_t params,
                                         uint32_t results,
                                         ...);
   ...
   *  ``` */
  void (*wasm_rt_allocate_memory)(void* context,
                                  wasm_rt_memory_t*,
   ...
   *    }
   *  ``` */
  uint32_t (*wasm_rt_grow_memory)(void* context,
                                  wasm_rt_memory_t*,
                                  uint32_t pages);
   ...
   *  ``` */
  void (*wasm_rt_allocate_table)(void* context,
                                 wasm_rt_table_t*,
                                 uint32_t elements,
  ...
  wasm_rt_func_handle_t (*wasm_rt_resolve_func)(void* context,
                                                char* module,
                                                char* name);
  /* 根据一个function handle发起一个函数的调用 */                                              
  uint32_t (*wasm_rt_call_func)(void* context,
                                wasm_rt_func_handle_t hfunc,
                                uint32_t* params,
                                uint32_t param_len);
