...
func (*ComplianceCheckResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_xcheck_48d37912f71be3ef, []int{0}
}
...
func (*TransferCheckResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_xcheck_48d37912f71be3ef, []int{1}
}
...
func init() { proto.RegisterFile("xcheck.proto", fileDescriptor_xcheck_48d37912f71be3ef) }

var fileDescriptor_xcheck_48d37912f71be3ef = []byte{
