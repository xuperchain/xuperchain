...
func (c *p2PServiceClient) SendP2PMessage(ctx context.Context, opts ...grpc.CallOption) (P2PService_SendP2PMessageClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_P2PService_serviceDesc.Streams[0], c.cc, "/xuperp2p.p2pService/SendP2pMessage", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("server.proto", fileDescriptor_server_972143f022aa4c85) }

var fileDescriptor_server_972143f022aa4c85 = []byte{
