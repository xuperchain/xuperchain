...
function QueryDonor(t) {
    c = Cost(t)
    resp = c.Invoke("QueryDonor", {"donor":"donor1"})
...
function QueryDonates(t) {
    c = Cost(t)
    resp = c.Invoke("QueryDonates", {"start":"00000000000000000005","limit":"10"})
...
function QueryCosts(t) {
    c = Cost(t)
    resp = c.Invoke("QueryCosts", {"start":"00000000000000000001","limit":"10"})
    console.log(resp.Message)
