...
constexpr size_t xchain_sizeof(T (&arr)[N]) {
    return N;
}
...
public:                                                                        \
    ...
    size_t index_size() { return index_.size() / 2; }                          \
    bool has(std::string index) { return index_.find(index) != index_.end(); } \
                                                                               \
private:                                                                       \
    std::map<std::string, std::function<std::string()>> index_ = {
#define DEFINE_INDEX_ADD_0(id) \
    {#id, [&]() -> std::string { return xchain_concat(#id); }},

#define DEFINE_INDEX_ADD_1(id, _1)                               \
    {xchain_concat(#_1),                                         \
     [&]() -> std::string { return xchain_concat(#_1, _1()); }}, \
        {#id, [&]() -> std::string { return xchain_concat(#_1); }},

#define DEFINE_INDEX_ADD_2(id, _1, _2)                                      \
    {xchain_concat(#_1, #_2),                                               \
     [&]() -> std::string { return xchain_concat(#_1, _1(), #_2, _2()); }}, \
        {#id, [&]() -> std::string { return xchain_concat(#_1, #_2); }},

#define DEFINE_INDEX_ADD_3(id, _1, _2, _3)                      \
    {xchain_concat(#_1, #_2, #_3),                              \
     [&]() -> std::string {                                     \
         return xchain_concat(#_1, _1(), #_2, _2(), #_3, _3()); \
     }},                                                        \
        {#id, [&]() -> std::string { return xchain_concat(#_1, #_2, #_3); }},

#define DEFINE_INDEX_ADD_4(id, _1, _2, _3, _4)                             \
    {xchain_concat(#_1, #_2, #_3, #_4),                                    \
     [&]() -> std::string {                                                \
         return xchain_concat(#_1, _1(), #_2, _2(), #_3, _3(), #_4, _4()); \
     }},                                                                   \
        {#id,                                                              \
         [&]() -> std::string { return xchain_concat(#_1, #_2, #_3, #_4); }},

#define OVERLOAD_MACRO(_1, _2, _3, _4, _5, NAME, ...) NAME
#define DEFINE_INDEX_ADD(...)                                                  \
    OVERLOAD_MACRO(__VA_ARGS__, DEFINE_INDEX_ADD_4, DEFINE_INDEX_ADD_3,        \
                   DEFINE_INDEX_ADD_2, DEFINE_INDEX_ADD_1, DEFINE_INDEX_ADD_0, \
                   ...)                                                        \
    (__VA_ARGS__)
