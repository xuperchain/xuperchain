...
DEFINE_METHOD(Award, initialize) { self.initialize(); }

DEFINE_METHOD(Award, addAward) { self.addAward(); }

DEFINE_METHOD(Award, totalSupply) { self.totalSupply(); }

DEFINE_METHOD(Award, balance) { self.balance(); }

DEFINE_METHOD(Award, allowance) { self.allowance(); }

DEFINE_METHOD(Award, transfer) { self.transfer(); }

DEFINE_METHOD(Award, transferFrom) { self.transferFrom(); }

DEFINE_METHOD(Award, approve) { self.approve(); }
