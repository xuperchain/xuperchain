...
var codePath = "../short-content/target/short-content-0.1.0-jar-with-dependencies.jar"
...
function QueryByTitle() {
    var c = beforeTest()
    var resp = c.Invoke("queryByTitle", { "user_id": "user1", "topic": "topic1", "title": "title1" })
    console.log(resp.Body, resp.Message)
}

function QueryByTopic() {
    var c = beforeTest()
    var resp = c.Invoke("queryByTopic", { "user_id": "user1", "topic": "topic1" })
    console.log(resp.Body, resp.Message)
}
