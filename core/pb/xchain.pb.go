...
type GetHashesMsgBody struct {
	...
	HeaderBlockId        []byte   `protobuf:"bytes,2,opt,name=HeaderBlockId,proto3" json:"HeaderBlockId,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetHashesMsgBody) GetHeaderBlockId() []byte {
	if m != nil {
...
func (m *HashesMsgBody) GetBlockIds() [][]byte {
	if m != nil {
		return m.BlockIds
	}
	return nil
...
type GetBlocksMsgBody struct {
	BlockList            [][]byte `protobuf:"bytes,1,rep,name=BlockList,proto3" json:"BlockList,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetBlocksMsgBody) GetBlockList() [][]byte {
	if m != nil {
		return m.BlockList
	}
	return nil
...
var fileDescriptor_db0991b9525664ca = []byte{
	...
	,
}
