...
type EndorserRequest struct {
	...
	BcName               string       `protobuf:"bytes,3,opt,name=BcName" json:"BcName,omitempty"`
	Fee                  *Transaction `protobuf:"bytes,4,opt,name=Fee" json:"Fee,omitempty"`
...
func (*EndorserRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_xendorser_392ea45ce6f070c1, []int{0}
}
...
func (dst *EndorserRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EndorserRequest.Merge(dst, src)
}
...
type EndorserResponse struct {
	Header               *Header        `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	ResponseName         string         `protobuf:"bytes,2,opt,name=ResponseName" json:"ResponseName,omitempty"`
	EndorserAddress      string         `protobuf:"bytes,3,opt,name=EndorserAddress" json:"EndorserAddress,omitempty"`
	EndorserSign         *SignatureInfo `protobuf:"bytes,4,opt,name=EndorserSign" json:"EndorserSign,omitempty"`
...
func (*EndorserResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_xendorser_392ea45ce6f070c1, []int{1}
}
...
func (dst *EndorserResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EndorserResponse.Merge(dst, src)
}
...
// Client API for Xendorser service
...
func (c *xendorserClient) EndorserCall(ctx context.Context, in *EndorserRequest, opts ...grpc.CallOption) (*EndorserResponse, error) {
	...
	err := grpc.Invoke(ctx, "/pb.xendorser/EndorserCall", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for Xendorser service
...
func init() { proto.RegisterFile("xendorser.proto", fileDescriptor_xendorser_392ea45ce6f070c1) }

var fileDescriptor_xendorser_392ea45ce6f070c1 = []byte{
